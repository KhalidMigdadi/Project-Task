<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Tasks.AdminPage" %>
             ...
             <div class="col-2 mb-4">
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <asp:Button ID="btnAll" runat="server" OnClick="btnAll_Click" Text="Add Books" />
                     </div>
                 </div>
             </div>
             <div class="col-2 mb-4">
             ...
             <div class="col-2 mb-4">
                 <div class="card">
                     ...
                     <div class="card-body">
                         ...
                         <asp:Button ID="btnMeet" runat="server" OnClick="btnMeet_Click" Text="Add meeting room"/>
                     </div>
                 </div>
             </div>
         </div>
